...
def generate_submission():
    """
        生成结果
    """
    if os.path.exists(arguments.fold_data_0_sub_path) and os.path.exists(
            arguments.fold_data_1_sub_path) and os.path.exists(arguments.fold_data_2_sub_path) and os.path.exists(
        arguments.fold_data_3_sub_path) and os.path.exists(arguments.fold_data_4_sub_path):
        ...
        fold_submission = fold_data_0_sub[[arguments.label_0, arguments.label_1, arguments.label_2]] + fold_data_1_sub[
            [arguments.label_0, arguments.label_1, arguments.label_2]] + fold_data_2_sub[
                              [arguments.label_0, arguments.label_1, arguments.label_2]] + fold_data_3_sub[
                              [arguments.label_0, arguments.label_1, arguments.label_2]] + fold_data_4_sub[
